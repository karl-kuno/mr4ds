...
* How to manipulate data with the exceptionally popular open source package `dplyr`
...
* Using the `dplyrXdf` Package to Manipulate Data and Train Many Models
...
* R Server 8.0.5 or above (most recent version is 9.1.0)
* Azure Credits
